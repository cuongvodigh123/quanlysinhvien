        ...
        <div class="card">
            <div class="card-body">
                <c:if test="${giangvien != null}">
                    <form id="formMH" action="ServerGiangVien" method="post">
                ...
                <caption>
                    <h2>
                        <c:if test="${giangvien != null}">Chỉnh sửa giảng viên</c:if>
                        <c:if test="${giangvien == null}">Tạo mới giảng viên</c:if>
                    </h2>
                </caption>
                <c:if test="${giangvien != null}">
                    <fieldset class="form-group">
                    <label>Mã Id giảng viên:</label> 
                    <input type="text" value="<c:out value='${giangvien.getId()}' />" class="form-control" id="idgiangvien" required="required" readonly="readonly">
                	</fieldset>
                </c:if>
                <c:if test="${giangvien == null}">
                    <fieldset class="form-group">
                    <label>Mã Id giảng viên:</label> 
                    <input type="text" value="" class="form-control" id="idgiangvien" required="required">
                	</fieldset>
                </c:if>
                <fieldset class="form-group">
...
<script type="text/javascript" src="admin/giangvien/edit.js"></script>
</html>